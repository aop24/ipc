...
public class FXMLMenuPrincipall implements Initializable {
    ...
    @FXML
    private void OnClickedExercice(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/preguntas/selecmodo.fxml"));
        Stage stage = new Stage();
        Scene scene = new Scene(root);
        stage.setTitle("MODOS");
